...
class TopupMultiplePromotionCriteriaFamilyAmountServiceTest {
    @InjectMocks
    ...
    fun checkCriteriaAmount_AmountDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_amount_promotion_success(),
        )
    ...
    fun checkCriteriaAmount_AmountDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_amount_error(),
        )
    ...
    fun checkCriteriaAmount_PercentDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_percent_promotion_success(),
        )
        Assert.assertEquals(true, promotion.promotionModel.isApplied)
...
//        Assert.assertEquals("", promotion.message)
    ...
    fun checkCriteriaAmount_PercentDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_percent_promotion_error(),
        )
        Assert.assertEquals(false, promotion.promotionModel.isApplied)
    }
    ...
    fun checkCriteriaAmount_SkuDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_sku_promotion_success(),
        )
        Assert.assertEquals(true, promotion.promotionModel.isApplied)
        Assert.assertEquals("", promotion.message)
    }
    ...
    fun checkNormalAmount_SkuDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleFamilyDataSource.get_amount_sku_promotion_error(),
        )
        Assert.assertEquals(false, promotion.promotionModel.isApplied)
    }
}