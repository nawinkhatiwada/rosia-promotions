...
class TopupMultiplePromotionCriteriaGroupQuantityServiceTest {
    @InjectMocks
    ...
    fun checkCriteriaQuantity_AmountDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_amount_success(),
        )
    ...
    fun checkCriteriaQuantity_AmountDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_amount_error(),
        )
    ...
    fun checkCriteriaQuantity_PercentDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_percent_success(),
        )
        Assert.assertEquals(true, promotion.promotionModel.isApplied)
    ...
    fun checkCriteriaQuantity_PercentDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_percent_error(),
        )
        Assert.assertEquals(false, promotion.promotionModel.isApplied)
    }
    ...
    fun checkCriteriaQuantity_SkuDisbursement_shouldReturnTrue() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_sku_success(),
        )
        Assert.assertEquals(true, promotion.promotionModel.isApplied)
    ...
    fun checkNormalQuantity_SkuDisbursement_onError() {
        ...
        promotionService.checkPromotion(
            promotionModel = TopupMultipleGroupDataSource.get_quantity_sku_error(),
        )
        Assert.assertEquals(false, promotion.promotionModel.isApplied)
    }
}