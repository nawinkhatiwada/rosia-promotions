package com.rosia.promotionservice.promotion.service.topup
...
object DataSource {
    ...
    fun get_topup_multiple_quantity_percent_promotion_success(): PromotionModel {
        ...
        return PromotionModel(
            ...
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 50, skuId = 1),
                getFakePromotionSkuModel(quantity = 50, skuId = 2)
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2"),
                getFakeApplicableSkuModel(2, 1, "1,2")
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_sku_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                ...
                getFakePromotionSkuModel(quantity = 2, skuId = 3)
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2,3", skuMoq = 5),
                getFakeApplicableSkuModel(2, 1, "1,2,3", skuMoq = 10),
                getFakeApplicableSkuModel(3, 1, "1,2,3", skuMoq = 20)
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_sku_group_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            promotionType = PromotionConstant.PROMOTION_TYPE_TOP_UP,
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 5, skuId = 1),
                getFakePromotionSkuModel(quantity = 5, skuId = 2),
                getFakePromotionSkuModel(quantity = 5, skuId = 3)
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2,3", skuGroupMoq = 20),
                getFakeApplicableSkuModel(2, 1, "1,2,3", skuGroupMoq = 20),
                getFakeApplicableSkuModel(3, 1, "1,2,3", skuGroupMoq = 20)
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_multiple_group_success(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 50, skuId = 1),
                getFakePromotionSkuModel(quantity = 50, skuId = 2),
                getFakePromotionSkuModel(quantity = 50, skuId = 3),
                getFakePromotionSkuModel(quantity = 50, skuId = 4)
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2", skuGroupMoq = 2),
                getFakeApplicableSkuModel(2, 1, "1,2", skuGroupMoq = 2),
                getFakeApplicableSkuModel(3, 2, "3,4", skuGroupMoq = 2),
                getFakeApplicableSkuModel(4, 2, "3,4", skuGroupMoq = 2)
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_multiple_group_sku_error(): PromotionModel {
        return PromotionModel(
            ...
            promotionType = PromotionConstant.PROMOTION_TYPE_TOP_UP,
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 50, skuId = 1, skuName = "Vicks 1"),
                getFakePromotionSkuModel(quantity = 50, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 1, skuId = 3, skuName = "Vicks 3"),
                getFakePromotionSkuModel(quantity = 1, skuId = 44, skuName = "Vicks 4")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(2, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(3, 2, "3,4", skuGroupMoq = 10),
                getFakeApplicableSkuModel(4, 2, "3,4", skuGroupMoq = 10)
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_multiple_group_sku_group_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 50, skuId = 1, skuName = "Vicks 1"),
                getFakePromotionSkuModel(quantity = 50, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 5, skuId = 3, skuName = "Vicks 3"),
                getFakePromotionSkuModel(quantity = 5, skuId = 44, skuName = "Vicks 4")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(2, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(3, 2, "3,4", skuGroupMoq = 12),
                getFakeApplicableSkuModel(4, 2, "3,4", skuGroupMoq = 12)
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_percent_promotion_multiple_group_error(): PromotionModel {
        return PromotionModel(
            ...
            promotionType = PromotionConstant.PROMOTION_TYPE_TOP_UP,
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 20, skuId = 1, skuName = "Vicks 1"),
                getFakePromotionSkuModel(quantity = 20, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 10, skuId = 3, skuName = "Vicks 3"),
                getFakePromotionSkuModel(quantity = 10, skuId = 4, skuName = "Vicks 4")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(2, 1, "1,2", skuGroupMoq = 20),
    ...
    fun get_topup_multiple_quantity_amount_promotion_success(): PromotionModel {
        ...
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2,3"),
                getFakeApplicableSkuModel(2, 1, "1,2,3"),
                getFakeApplicableSkuModel(3, 1, "1,2,3")
            )
        )
    }
    ...
    fun get_topup_multiple_quantity_amount_promotion_multiple_group_sku_group_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                ...
                getFakePromotionSkuModel(quantity = 50, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 5, skuId = 3, skuName = "Vicks 3"),
                getFakePromotionSkuModel(quantity = 5, skuId = 4, skuName = "Vicks 4")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModel(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModel(2, 1, "1,2", skuGroupMoq = 20),
    ...
    fun get_topup_multiple_amount_percent_promotion_success(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                ...
                getFakePromotionSkuModel(quantity = 80, skuId = 2),
                getFakePromotionSkuModel(quantity = 20, skuId = 3)
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3"),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3"),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3")
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_sku_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakePromotionSkuModel(quantity = 20, skuId = 1, skuName = "Vicks 1"),
                getFakePromotionSkuModel(quantity = 10, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 4, skuId = 3, skuName = "Vicks 3")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3", skuMoq = 5),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3", skuMoq = 10),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3", skuMoq = 25)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_sku_group_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3", skuGroupMoq = 1900),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3", skuGroupMoq = 1900),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3", skuGroupMoq = 1900)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_error(): PromotionModel {
        ...
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3", skuGroupMoq = 20)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_multiple_group_success(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 2),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 2),
                getFakeApplicableSkuModelWithAmountCriteria(3, 2, "3,4", skuGroupMoq = 2),
                getFakeApplicableSkuModelWithAmountCriteria(4, 2, "3,4", skuGroupMoq = 2)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_multiple_group_sku_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(3, 2, "3,4", skuGroupMoq = 10),
                getFakeApplicableSkuModelWithAmountCriteria(4, 2, "3,4", skuGroupMoq = 10)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_multiple_group_sku_group_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(3, 2, "3,4", skuGroupMoq = 120),
                getFakeApplicableSkuModelWithAmountCriteria(4, 2, "3,4", skuGroupMoq = 120)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_percent_promotion_multiple_group_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(3, 2, "3,4", skuGroupMoq = 12),
                getFakeApplicableSkuModelWithAmountCriteria(4, 2, "3,4", skuGroupMoq = 12)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_amount_promotion_success(): PromotionModel {
        ...
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2"),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2")
            )
        )
    }
    ...
    fun get_topup_multiple_amount_amount_promotion_sku_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3", skuMoq = 50),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3", skuMoq = 100),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3", skuMoq = 20)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_amount_promotion_sku_group_moq_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2,3", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2,3", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(3, 1, "1,2,3", skuGroupMoq = 200)
            )
        )
    }
    ...
    fun get_topup_multiple_amount_amount_promotion_multiple_group_sku_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                ...
                getFakePromotionSkuModel(quantity = 50, skuId = 2, skuName = "Vicks 2"),
                getFakePromotionSkuModel(quantity = 5, skuId = 3, skuName = "Vicks 3"),
                getFakePromotionSkuModel(quantity = 1, skuId = 4, skuName = "Vicks 4")
            ),
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 20),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 20),
    ...
    fun get_topup_multiple_amount_amount_promotion_multiple_group_sku_group_error(): PromotionModel {
        return PromotionModel(
            ...
            applicableSkuModelList = listOf(
                getFakeApplicableSkuModelWithAmountCriteria(1, 1, "1,2", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(2, 1, "1,2", skuGroupMoq = 200),
                getFakeApplicableSkuModelWithAmountCriteria(3, 2, "3,4", skuGroupMoq = 150),
                getFakeApplicableSkuModelWithAmountCriteria(4, 2, "3,4", skuGroupMoq = 150)
            )
        )
    }
