...
object NormalSingleFamilyDataSource {
    ...
    fun get_amount_amount_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy worth 2000 and get 100 rs off",
    ...
    fun get_amount_percent_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy products of worth 2000 and get 10% off",
            promotionState = PromotionConstant.SINGLE_PROMOTION,
            criteriaId = 1,
            criteriaType = PromotionConstant.CRITERIA_AMOUNT,
            criteriaMaxOpr = OperatorConstants.GREATER_THAN_EQUALS,
    ...
    fun get_amount_percent_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 250, skuId = 1)
            )
        )
    }
    ...
    fun get_amount_sku_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy products worth 2000 and get 1 for free",
            promotionState = PromotionConstant.SINGLE_PROMOTION,
            criteriaId = 1,
            criteriaType = PromotionConstant.CRITERIA_AMOUNT,
            criteriaMaxOpr = OperatorConstants.GREATER_THAN_EQUALS,
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 310, skuId = 1)
            )
        )
    }
    ...
    fun get_amount_sku_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 220, skuId = 1)
            )
        )
    }
    ...
    fun get_quantity_amount_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy 10 pcs and get 10 rs off",
            promotionState = PromotionConstant.SINGLE_PROMOTION,
            criteriaId = 1,
            criteriaType = PromotionConstant.CRITERIA_QUANTITY,
            criteriaMaxOpr = OperatorConstants.GREATER_THAN_EQUALS,
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 16, skuId = 1)
            )
        )
    }
    ...
    fun get_quantity_amount_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 11, skuId = 1)
            )
        )
    }
    ...
    fun get_quantity_percent_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy 10 pcs and get 10 % off",
            promotionState = PromotionConstant.SINGLE_PROMOTION,
            criteriaId = 1,
            criteriaType = PromotionConstant.CRITERIA_QUANTITY,
            criteriaMaxOpr = OperatorConstants.GREATER_THAN_EQUALS,
    ...
    fun get_quantity_percent_error(): PromotionModel {
        return PromotionModel(
            ...
            skuList = listOf(
                getFakeFamilyPromotionSkuModel(quantity = 12, skuId = 1)
            )
        )
    }
    ...
    fun get_quantity_sku_success(): PromotionModel {
        return PromotionModel(
            promotionId = 1,
            title = "Buy 10 pcs and get 1 sku free",
            promotionState = PromotionConstant.SINGLE_PROMOTION,
            criteriaId = 1,
            criteriaType = PromotionConstant.CRITERIA_QUANTITY,
            criteriaMaxOpr = OperatorConstants.GREATER_THAN_EQUALS,
